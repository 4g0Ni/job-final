...
4 年微软 Microsoft Advertising 软件工程经验，工作主线覆盖 **AI Agent 与大型广告 UI**。设计并实现面向多仓库历史变更与回归调查的 evidence-first 检索 Agent，具备混合召回、Agent 编排、MCP、拒答门禁、分层评测与可观测性的端到端实践；同时在 Campaign UI 中长期负责性能、素材、监测、Deal、推荐与质量工程，并拥有广告后端项目的完整协作与交付经验。
